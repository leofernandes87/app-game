...
rm -f ./deployments/app-game-1.0-SNAPSHOT.war.failed \       
      ./deployments/app-game-1.0-SNAPSHOT.war.undeployed
```
...
- **Console Adminer Banco de Dados**: [http://localhost:8081](http://localhost:9990)
    - Servidor: `db`
    - Usuário: `leonardo`
    - Senha: `admin`
